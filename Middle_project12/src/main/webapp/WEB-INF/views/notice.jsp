...
<body class="is-preload">
	...
	<div id="wrapper">
		...
		<section id="banner" class="style2">
			<div class="inner">
				<span class="image"> <img src="resources/images/asd.jpg"
					alt="" />
				</span>
				<header class="major">

					<h1
						style="color: rgba(123, 172, 118, 0.774);;; font-family: sans-serif;">유의사항</h1>
				</header>
				<p
					style="color: rgba(123, 172, 118, 0.774);;; font-size: 15px; font-family: sans-serif;">제품
					사용 안내 및 주의사항</p>
		...
		<div id="main">
			...
			<section id="one">
				<div class="inner">
					...
					<p style="color: rgba(123, 172, 118, 0.774);">오래된 기기나 최신 버전의
						운영체제를 지원하지 않는 기기는 호환성 문제가 발생할 수 있습니다</p>
					<a href="generic.html" class="image"> <img
						src="resources/images/candy.jpg" alt=""
				...
				<section>
					...
					<div class="content">
						<div class="inner">
							...
							<p style="color: rgba(123, 172, 118, 0.774);">GPS 시스템 자체의 보정
								문제 와 내부 시계의 오차 문제가 정확도에 영향을 미칠 수 있습니다</p>
						</div>
					</div>
					<a href="generic.html" class="image"> <img
						src="resources/images/gps.gif" alt=""
						data-position="center center" />
					</a>
				</section>
