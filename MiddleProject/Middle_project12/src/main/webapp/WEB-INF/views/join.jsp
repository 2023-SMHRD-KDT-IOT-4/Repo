							...
							<div id="wrapper" width="400px">
								...
								<!-- Header -->
										...
										<div class="content">
											<div class="inner">
												<h1>회원가입</h1>
												<form action="joinClick" method=post>
													...
													<div class="input_row" id="pw_line">
														...
														<br>
														<input type="text" id="pw" name="pw" placeholder="이름" title="이름" class="input_text" maxlength="16">
														<span role="button" class="btn_delete" id="pw_clear" style="display: none;">
															<span class="icon_delete">
																<span class="blind">삭제</span>
															</span>
													...
													<div class="input_row" id="pw_line">
														...
														<br>
														<input type="password" id="pw" name="pw" placeholder="비밀번호  확인" title="비밀번호  확인" class="input_text" maxlength="16">
														<span role="button" class="btn_delete" id="pw_clear" style="display: none;">
															<span class="icon_delete">
																<span class="blind">삭제</span>
															</span>
													...
													<div class="input_row" id="pw_line">
														...
														<br>
														<input type="date" id="pw" name="pw" placeholder="생년월일" title="생년월일" class="input_text" maxlength="16">
														<span role="button" class="btn_delete" id="pw_clear" style="display: none;">
															<span class="icon_delete">
																<span class="blind">삭제</span>
															</span>
										...
										<nav>
											<ul class="alert_wrap" id="alert_wrap">
												<button onclick="location.href='joinClick'" type="submit" class="alert_text" id="log.join">
																		<span class="btn_text">회원가입 완료</span>
												</button>						
											</ul>
