								...
								<ul class="panel_wrap">
									<li class="panel_item" style="display: block;">
										<div class="panel_inner" role="tabpanel" aria-controls="loinid">
											<div class="id_pw_wrap">
												...
												<div class="input_row" id="pw_line">
													...
													<br>
													<input type="text" id="name" name="name" placeholder="이름" title="이름" class="input_text"
														maxlength="16">
												...
												<div class="input_row" id="pw_line">
													...
													<br>
													<input type="password" id="pw" name="pw" placeholder="비밀번호  확인" title="비밀번호  확인"
												...
												<div class="input_row" id="pw_line">
													...
													<br>
													<input type="password" id="pw" name="pw" placeholder="프로필 이미지" title="프로필 이미지"
														class="input_text" maxlength="16">
													<span role="button" class="btn_delete" id="pw_clear" style="display: none;">
														<span class="icon_delete">
															<span class="blind">삭제</span>
										...
										<ul class="alert_wrap" id="alert_wrap">
											<button onclick="location.href='login.html';" type="submit" class="alert_wrap" id="log.join">
