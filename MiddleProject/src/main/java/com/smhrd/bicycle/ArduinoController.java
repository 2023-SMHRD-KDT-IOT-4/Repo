...
//	}
	...
	public String DBLocation(@RequestParam("latitude") Double lat,@RequestParam("longitude") Double lng,@RequestParam("user_id") String user_id,HttpSession session,@RequestParam("theft") int theft) {
