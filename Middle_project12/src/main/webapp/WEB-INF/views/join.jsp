					...
					<form action="joinClick" method=post enctype="multipart/form-data">
						...
						<div class="input_row" id="pw_line">
							<div class="icon_cell" id="pw_cell">
								<span class="icon_pw"> <span class="blind">프로필 이미지</span>
							...
							<div class="input_row" id="pw_line">
								<div class="icon_cell" id="pw_cell">
									<span class="icon_pw"> <span class="blind">이름</span>
									</span>
								</div>
								<br> <input type="text" id="pw" name="user_name"
									placeholder="이름" title="이름" class="input_text" maxlength="16">
							...
							<div class="input_row" id="pw_line">
								...
								<br> <input type="password" id="pw" name="user_pw2"
							...
							<div class="input_row" id="pw_line">
								<div class="icon_cell" id="pw_cell">
									<span class="icon_pw"> <span class="blind">생년월일 </span>

									</span>
								</div>
								<br> <input type="date" id="pw" name="user_birthdate"
						...
						<ul class="alert_wrap" id="alert_wrap">
							<input type="submit" class="alert_text" id="log.join"
								value="회원가입 완료">
						</ul>
