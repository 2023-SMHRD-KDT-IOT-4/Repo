	...
	<div id="wrapper">
				...
				<div class="inner">
					...
					<hr>
						...
						<div id="container" class="container">
							...
							<form id="frmNIDLogin" name="frmNIDLogin" target="_top" autocomplete="off" action="update" method="POST" enctype="multipart/form-data">
	                        <ul class="panel_wrap">
	                           <li class="panel_item" style="display: block;">
	                              <div class="panel_inner" role="tabpanel" aria-controls="loinid">
	                                 <div class="id_pw_wrap">
	                                    <div1 style="margin-left:50px; font-size: 60px; font-family: fantasy;">My page</div1> 
	                                    <div class="input_row" id="pw_line">
	                                       ...
	                                       <br>
	                                       <input type="text" id="name" name="name1" placeholder="이름" title="이름" class="input_text"
	                                    ...
	                                    <div class="input_row" id="pw_line">
	                                       <div class="icon_cell" id="pw_cell">
	                                          <span class="icon_pw">
	                                             <span class="blind">변경 할 비밀번호</span>
	                                          </span>
	                                       </div>
	                                       <br>
	                                    ...
	                                    <div class="input_row" id="pw_line">
	                                       ...
	                                       <br>
	                                       <input type="password" id="pw2" name="pw2" placeholder="비밀번호  확인" title="비밀번호  확인" class="input_text" maxlength="16">
	                                    </div>
	                                    <br>
	                                    <div class="input_row" id="pw_line">
	                                       <div class="icon_cell" id="pw_cell">
	                                          <span class="icon_pw">
	                                             ...
	                                             <input type="date" id="birthdate" name="birthdate" placeholder="생년월일" title="생년월일" class="input_text" style="color: black;">
	                                       </div>
	                                       <br>
	                                    </div>
	                                    <br>
		...
		<script>
			document.getElementById('birthdate').addEventListener('change', function() {
					...
					document.getElementById('displayBirthdate').innerText = "생년월일: " + selectedDate;
			});
			</script>
			<script>
